...
/**
 * Klasse um eine Text-Datei mit AES Verschlüsslungsverfahren, und
 * Verschiedene blockMode wie (ECB , CBC , CTS ), und viersciedene Padding zu Verschlüsseln/Entschlüsseln
 * @author Abdulkader Benni
 * @version 17.05.20021
 */
...
public class AESEncrypt {
     ...
     */
    public AESEncrypt(String blockMode, String padding) throws Exception {
    ...
    public Cipher getCipher() throws NoSuchPaddingException, NoSuchAlgorithmException, NoSuchProviderException {
      cipher = Cipher.getInstance("AES/" + this.blockMode + "/" + this.padding, "BC");
        return cipher;
    }
    ...
    public byte[] Encrypt( SecretKey key) throws Exception {
        ...
        if (this.blockMode != "ECB"){
            ...
            //die Chiffre in ENCRYPT_MODE initialisieren ohne iv
    ...
    public byte[] Decrypt (byte[] output  , SecretKey key) throws Exception {
       // das Cipher Object für AES
        ...
        if (this.blockMode != "ECB"){
            ...
            //die Chiffre in DECRYPT_MODE initialisieren ohne iv
    ...
    public static void main(String[] args) throws Exception {
        ...
        AESEncrypt obj = new AESEncrypt("ECB" , "PKCS7Padding");
        obj.test();
        ReadFile.fileou();
